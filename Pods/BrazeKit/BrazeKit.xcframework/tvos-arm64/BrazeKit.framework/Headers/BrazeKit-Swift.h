...
/// Provided for compatibility.
/// Type: ABKFeedController
@property (nonatomic, readonly, strong) id _Nonnull feedController SWIFT_DEPRECATED_MSG("", "newsFeed");
/// Provided for compatibility.
...
/// Provided for compatibility.
- (void)logFeedDisplayed SWIFT_DEPRECATED_MSG("logging the feed displayed event is not needed anymore");
/// Provided for compatibility.
- (void)logContentCardsDisplayed SWIFT_DEPRECATED_MSG("logging the content cards displayed event is not needed anymore");
/// Provided for compatibility.
- (void)requestFeedRefresh SWIFT_DEPRECATED_MSG("renamed to 'newsFeed.requestRefresh(_:)'");
/// Provided for compatibility.
